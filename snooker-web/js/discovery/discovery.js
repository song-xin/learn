			...
			success:function(data){
				if(data&&data.data&&data.data.length>0){
					$.each(data.data,function(index,against){
						...
						$("#liveDiv").append("<div class='live-against'>"
												...
												+"<div class='live-against-set mid'>"
													...
													+"<div class='1-score-2'>"
														+"<div class='mid red'>"+against.player1.totalSetScore+"</div>"
														+"<div class='mid'>局分</div>"
														+"<div class='mid red'>"+against.player2.totalSetScore+"</div>"
													+"</div>"
													+"<div class='1-score-2'>"
														+"<div class='mid red'>"+against.player1.thisSetScore+"</div>"
														+"<div class='mid'>本局比分</div>"
														+"<div class='mid red'>"+against.player2.thisSetScore+"</div>"
													+"</div>"
													+"<div class='1-score-2'>"
														+"<div class='mid red'>"+p1breakScore+"</div>"
														+"<div class='mid'>单杆得分</div>"
														+"<div class='mid red'>"+against.player2.breakScore+"</div>"
													+"</div>"
